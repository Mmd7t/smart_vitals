...
class RadialProgressPressure extends StatefulWidget {
  ...
  @override
  _RadialProgressPressureState createState() => _RadialProgressPressureState();
}
...
class _RadialProgressPressureState extends State<RadialProgressPressure>
        ...
        child = Center(
          child: InkWell(
            ...
            onTap: () async {
              ...
              setState(() {
                messages.forEach((element) {
                  print('Received List ::::: ' + element.text);
                });
              });
            },
            child: GradientText(
