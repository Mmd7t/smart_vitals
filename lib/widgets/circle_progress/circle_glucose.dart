...
class RadialProgressGlucose extends StatefulWidget {
  ...
  @override
  _RadialProgressGlucoseState createState() => _RadialProgressGlucoseState();
}
...
class _RadialProgressGlucoseState extends State<RadialProgressGlucose>
        ...
        child = Center(
          child: InkWell(
            ...
            onTap: () async {
              ...
              /*-------------------------------------------------------------------------------*/
              ReadDataServices.glucoseCreate(GlucoseHeartTempCreate(
